...
public class PizzaMessage {
    ...
    private static final List<String> pizzaShops = List.of("A001", "B001", "C001",
    ...
    public Map<String, String> produce_msg(Random random, int id) {
        Map<String, String> messageMap = new HashMap<>();
        Faker faker = Faker.instance(random);

        String shopId = getRandomValueFromList(pizzaShops, random);
    ...
    public static void main(String[] args) {
        ...
        for(int i=0; i < 60; i++) {
            Map<String, String> message = pizzaMessage.produce_msg(random, i);
